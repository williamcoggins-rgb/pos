...
class EventType(str, Enum):
    ...
    # Procurement Signal Events
    PROCUREMENT_READINESS_SIGNAL = "PROCUREMENT_READINESS_SIGNAL"
    PROCUREMENT_ADMIN_CONTACTED = "PROCUREMENT_ADMIN_CONTACTED"
    PROCUREMENT_ACTIVATED = "PROCUREMENT_ACTIVATED"

    # Legacy Procurement Events (kept for backward compat with existing events)
